...
def main():
    ...
    parser.add_argument("--asset-type", choices=("stock", "crypto"), default=None,
                        help="Asset type override (default: read from metadata.json)")
    ...
    allowed_actions = compute_allowed_actions(tickers, current_prices, max_shares, portfolio, fractional=fractional)
